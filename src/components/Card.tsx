...
function Card() {
    ...
    const items = [
        { 
            ...
            description: "We create modern, responsive, and high-performance websites designed to convert visitors into customers with speed, SEO, and user experience in focus.",
        ...
        { 
            ...
            description: "We build powerful e-commerce platforms with secure payment integration, product management workflows, and seamless experiences to maximize online sales.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            ...
            description: "We develop scalable and secure web applications including dashboards, admin panels, SaaS systems, and real-time business tools.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "AI, UI/UX & SEO", 
            description: "From AI chatbots and voice AI to modern UI/UX design and technical SEO optimization, we build growth-focused digital products end-to-end.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">

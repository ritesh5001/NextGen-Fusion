          ...
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gray-900 text-white py-2 px-4 rounded-lg font-medium hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center gap-2"
              >
